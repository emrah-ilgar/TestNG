...
public class ListOfElements {
    ...
    public void testName() throws InterruptedException {
        ...
        //List<WebElement> listItems = driver.findElements(By.xpath("//a[text()='A/B Testing']/../..//li/a"));  2side olur...
        List<WebElement> listItems = driver.findElements(By.xpath("//a[text()='A/B Testing']/../..//a"));
